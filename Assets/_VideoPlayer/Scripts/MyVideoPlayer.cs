...
public class MyVideoPlayer : MonoBehaviour
{
    ...
    public  VideoPlayer extractFamesVideoPlayer;
    private  ExtractFramesVideoPlayer extractFramesVideoPlayerScript;
    ...
    private void Start  ()
    {
        ...
        progressBarWidth = progressBarBG.GetComponent<SpriteRenderer>().bounds.size.x;
                  ...
                  extractFramesVideoPlayerScript = extractFamesVideoPlayer.GetComponent<ExtractFramesVideoPlayer>();
    ...
    private void VideoJump()
    {
        ...
        extractFramesVideoPlayerScript.videoPlayer.frame = (long)frame;
    }
    ...
    private void VideoStop()
    {
        ...
        videoPlayer.Pause();
        extractFramesVideoPlayerScript.videoPlayer.Pause();
        btnPause.SetActive(false);
        btnPlay.SetActive(true);
    }
    ...
    private void VideoPlay()
    {
        videoIsPlaying = true;
        videoPlayer.Play();
        extractFramesVideoPlayerScript.videoPlayer.Play();
